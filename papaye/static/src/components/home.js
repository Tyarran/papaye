    ...
    render() {
        return (
            <div className="content container">
                ...
                <Highlight className="bash">pip install your_package -i {this.props.simpleUrl}</Highlight>
                ...
                <Highlight className="dos">-i {this.props.simpleUrl} .</Highlight>


                <h3>Permanent configuration</h3>
                <p>Edit the ~/.pip/pip.conf file like:</p>

                <Highlight className="ini">{`[install]
...
index = ${this.props.simpleUrl}`}</Highlight>
                ...
                <Highlight className="ini" element="code">{`[distutils]
index-servers =
papaye
