        ...
        return (
            <div>
                <Content breadcrumb={breadcrumb} >
                    ...
                    <pre language="bash">pip install your_package -i {this.props.simpleUrl}</pre>
                    ...
                    <pre language="dos">-i {this.props.simpleUrl} .</pre>
...
[search]
index = ${this.props.simpleUrl}`}</pre>

                <h2>Uploading files</h2>

                Edit your ~/.pypirc file like:
                <pre language="ini" element="code">{`[distutils]
index-servers =
papaye
...
repository: ${this.props.simpleUrl}`}</pre>
                </Content>
            </div>
        );
    }
